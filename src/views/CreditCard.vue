<template>
    <div class="wrapper" :class="{ 'validation-error': error }">
        <div class="card-form">
            <div class="card-list">
                <div class="card-item" v-bind:class="{ '-active' : isCardFlipped }">
                    <div class="card-item__side -front">
                        ...
                        <div class="card-item__cover">
                            <img
                                    :src="`/images/${currentCardBackground}.jpeg`" class="card-item__bg">
                        </div>
                            ...
                            <div class="card-item__top">
                                ...
                                <div class="card-item__type">
                                    <transition name="slide-fade-up">
                                        <img :src="`/images/${getCardType}.png`" v-if="getCardType" v-bind:key="getCardType" alt="" class="card-item__typeImg">
                                    </transition>
                                </div>
                            </div>
                  ...
                  <transition name="slide-fade-up">
                    ...
                    <div class="card-item__side -back">
                        ...
                        <div class="card-item__cvv">
                            ...
                            <div class="card-item__type">
                                <img :src="`/images/${getCardType}.png`" v-if="getCardType" class="card-item__typeImg">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-form__row">
                    <div class="card-form__col">
                        <div class="card-form__group">
                            <label for="cardMonth" class="card-input__label">Окончание срока службы</label>
...
const closePopup = () => {
    error.value = false;
    if (cardNumber.value.length < (getCardType.value == 'amex' ? amexCardMask.value.length : otherCardMask.value.length)) {
        error.value = true;
        return;
    }
...
@media screen and (max-width: 480px) {
  .card-item__info {
    padding: 10px;
      box-shadow: 7px 6px 10px rgba(14, 42, 90, 0.8);
  }
}
.card-item__holder {
  opacity: 0.7;
...
/* ----------------------------------------------
 * Generated by Animista on 2023-5-8 12:23:38

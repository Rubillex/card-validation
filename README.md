...
Первое, что нужно было сделать — инициализировать Vue.js приложение. Для этого требуется установить Node.js, в данном случае была задействована версия 17.20.0.
